...
const commands = [
  ...
  { name: '/movienight', description: 'Everything, in one place',          usage: '/movienight', details: 'The hub: what\'s on next, what leads the board, and a menu into every other command. Only you see it.', category: 'Other' },
  { name: '/help',       description: 'Same as /movienight',              usage: '/help', details: 'The same hub screen, under the name people reach for first.', category: 'Other' },
  { name: '/board',      description: 'The suggestion board',             usage: '/board  ·  /board suggest:"Movie Name"', details: 'See what the server wants to watch and vote on it. Pass suggest: to add a film — pick from the search results so it arrives with its poster and runtime.', category: 'Movies' },
  { name: '/wishlist',   description: 'Your wishlist, or the server\'s',   usage: '/wishlist  ·  /wishlist server:true', details: 'Your list by priority, films someone else also wants, and a "pick one for me" weighted by how badly you want them. Only you see it.', category: 'Movies' },
  { name: '/marathon',   description: 'A running marathon',               usage: '/marathon', details: 'The full running order of a marathon — what\'s been watched and what it scored, what\'s scheduled, and what still needs a date.', category: 'Movies' },
